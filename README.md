...
- I wanted to achieve minimal latency, I'm controlling the speaker directly via HTTP. More scalable approach would be to use Home Assistant and connect via MQTT
